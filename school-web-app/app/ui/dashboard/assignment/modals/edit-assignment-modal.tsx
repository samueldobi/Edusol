...
export default function EditAssignmentModal({ onClose, onDelete }: EditAssignmentModalProps) {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-6 md:p-8 rounded-lg shadow-lg w-full max-w-xl">
        <h3 className="text-[#1AA939] font-bold text-xl mb-5 uppercase">Delete Assignment</h3>
