...
export default function ProfileSecurityForm() {
  return (
    <div className="bg-white rounded-lg shadow-lg w-[40%] max-w-[500px] min-w-[320px] flex flex-col p-6 sm:w-[90%] sm:p-20 md:w-[85%] lg:w-[60%] xl:w-[35%]">
      {/*Logo section*/}
      ...
      <div className="mt-4 w-full flex flex-col items-stretch">
        ...
        >
          ...
          <div className="flex justify-center">
            <button
              className="bg-indigo-950 font-bold w-full text-white px-20 py-3"
              type="submit"
            >
              Password settings
            </button>
